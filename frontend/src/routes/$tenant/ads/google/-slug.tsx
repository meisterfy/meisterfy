...
export function CampaignDetailRoute() {
  ...
  useEffect(() => {
    ...
    withFallback(getCampaign(tenant, slug), null)
      .then((c) => {
        ...
        setCampaign(
          normalizeCampaign(c, c.tenant_id) as unknown as CampaignDetail,
        )
      })
      .catch(() => {
  ...
  function setGroupName(i: number, name: string) {
    setCampaign((c) => {
      ...
      const ad_groups = c.ad_groups.map((g, idx) =>
        idx === i ? { ...g, name } : g,
      )
      return { ...c, ad_groups }
    })
              ...
              >
                ...
                <div className="border-t border-slate-100 pt-4 dark:border-slate-800">
                  ...
                  <div className="mb-4 space-y-3">
                    ...
                    {group.responsive_search_ad.headlines.map(
                      (headline, hi) => (
                  ...
                  <div className="space-y-3">
                    ...
                    {group.responsive_search_ad.descriptions.map(
                      (description, di) => (
