...
export const getAvailableMetaPages = (tenant: string, fetchFn?: typeof fetch) =>
	apiFetchData<MetaPage[]>(`/admin/tenants/${tenant}/meta/available-pages`, {}, fetchFn)

export const activateMetaPage = (tenant: string, page: Omit<MetaPage, 'already_connected'>) =>
