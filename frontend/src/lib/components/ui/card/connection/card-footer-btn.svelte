<script lang="ts">
	...
	const variants: Record<string, string> = {
		default: "text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800",
		primary: "text-slate-50 bg-slate-500/10 border border-slate-500/20 hover:bg-slate-500/20",
		secondary: "bg-slate-500/10 border border-slate-500/20 text-slate-700 dark:text-slate-200 hover:bg-slate-500/20",
	...
	const classes = $derived(`${base} ${padding} ${variants[variant] || variants.default} ${className}`)
</script>
