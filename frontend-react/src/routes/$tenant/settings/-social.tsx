...
export function SocialRoute() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setConnectedPages(
        await getConnectorResources(tenant, 'meta', 'page').catch(() => []),
      )
                ...
                {pagesLoading ? (
                  ...
                  <ul className="divide-y divide-slate-100 rounded-lg border border-slate-200 dark:divide-slate-800 dark:border-slate-700">
                    {connectedPages.map((resource) => {
                      const igUsername = resource.metadata?.ig_username as
                        | string
                        | null
                      return (
                        <li
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                <CheckboxCard
                  ...
                  description={t('social_report_daily_desc', {
                    time: localTime(6),
                  })}
                />
                <CheckboxCard
                  ...
                  description={t('social_report_weekly_desc', {
                ...
                <CheckboxCard
                  ...
                  description={t('social_report_monthly_desc', {
                    time: localTime(6),
                  })}
                />
              </div>
